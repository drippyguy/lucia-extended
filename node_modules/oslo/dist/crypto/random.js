...
exports.alphabet = exports.generateRandomString = exports.generateRandomInteger = exports.random = void 0;
...
function generateRandomInteger(max) {
    ...
    let result = (0, bytes_js_1.bytesToInteger)(bytes);
    while (result >= max) {
        crypto.getRandomValues(bytes);
        if (shift !== 0) {
            bytes[0] &= (1 << shift) - 1;
        }
        result = (0, bytes_js_1.bytesToInteger)(bytes);
    }
    return result;
}
